# -*- coding: utf-8 -*-
"""
Created on Wed Feb 03 11:49:08 2016
...
# Make arbitrary function of three variables
    ...
    dict_data=[]
    df=import_data('Hydrodynamics of Bubble Column.xlsx','ErrorAnalysis')
    Xdata,Ydata,Errdata = prepare_data(df,'y',('x','x'),Error= 'Error')
    #Initial Guess
    N=3
    pguess=N*[0.0]

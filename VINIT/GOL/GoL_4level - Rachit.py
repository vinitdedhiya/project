...
Simplifications: The border elements haven't been taken for simplicity
"""
import numpy as np
import collections
...
class GoL_4level():
    #Z=np.array([[0,0,0,0,0,0],[0,1,2,1,1,0],[0,1,0,2,2,0],[0,2,3,2,1,0],[0,2,1,0,3,0],[0,0,0,0,0,0]])    
    Z=np.random.randint(4,size=(50,50));
    Z[0:10,:]=0
    Z[:,0:10]=0
    Z[40:-1,:]=0
    Z[:,40:-1]=0

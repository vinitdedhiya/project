# -*- coding: utf-8 -*-
"""
Created on Mon Apr 11 00:10:00 2016
...
x2=1-x1
y1=0.99 #Initial guess value of Vapour Phase composition
R=0.08206
...
'''
def vap(y1):
    return x1*lnphiL1-y1*lnphiG1
    
yfinal=fsolve(vap,0.5)
print "Vapour Phase Composition of Component 1=",yfinal
'''
"""References:
